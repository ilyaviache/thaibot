...
export const TEXTS = {
  ...
  TASKS: {
    ...
    STATS: (daysCount = 0, messagesCount) =>
      `Бот слушает все чаты региона уже ${daysCount} дней и нашел ${messagesCount} сообщений. Если поиск не дает результатов, то попробуйте изменить ключевые слова и проверьте список игнорируемыъ чатов, слов и пользователей`,
  },
  AREA: {
